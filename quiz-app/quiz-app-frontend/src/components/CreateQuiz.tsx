...
type CreateQuizCreateion = Omit<Quiz, "id">;

const requestQuizCreation = async (quizData: CreateQuizCreateion) => {
  try {
...
export default function CreateQuiz() {
  const [quizFormData, setQuizFormData] = useState<CreateQuizCreateion>({
    question: "",
    choices: ["", ""],
    answer: 0,
  });
              ...
              <li key={index}>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setQuizFormData({
                      ...quizFormData,
                      choices: quizFormData.choices.filter(
                        (_, i) => i !== index
                      ),
                    });
                  }}
